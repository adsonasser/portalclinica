      ...
      <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
        ...
        <div style={{ width: 320, flexShrink: 0, display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div style={{ background: '#FFFFFF', border: '1px solid #EAECEF', borderRadius: 20, padding: '16px 18px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)' }}>
            ...
            <button onClick={() => navigate('/agenda')} style={{ width: '100%', height: 36, background: '#000000', border: 'none', borderRadius: 20, fontSize: 13, fontWeight: 600, color: '#FFFFFF', cursor: 'pointer', fontFamily: "'Inter', system-ui, sans-serif" }}>
              Ver agenda completa
            </button>
          </div>
